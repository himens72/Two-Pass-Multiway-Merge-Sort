...
public class BagDiffernce {
	...
	public static String mergeSort(ArrayList<String> sublist, int differ) {
		...
		for (int k = 0; k < sublist.size(); k = k + 2) {
			String list12 = System.getProperty("user.dir") + System.getProperty("file.separator") + "buffer1"
		...
		// System.out.println("iteration "+itertion+" in phase 2 merging time taken for
		// this iteration is"+ (System.currentTimeMillis() - itertionStart)+"ms");
